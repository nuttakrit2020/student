...
export async function POST(request) {
  try {
    ...
    const { subjectId, subjectName, className, adminKey, qrCode, adminAvatarUrl, targetLat, targetLng, targetRoomName, classSchedules, googleAppScriptUrl, holidays } = body;
    ...
    if (holidays !== undefined) globalUpdates.holidays = holidays;
